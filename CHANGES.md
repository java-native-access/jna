...
* [#338] Added `com.sun.jna.platform.mac.XAttr` and `com.sun.jna.platform.mac.XAttrUtil` JNA wrapper for <sys/xattr.h> for Mac OS X - [@rednoah](https://github.com/rednoah)
