...
* [#1178](https://github.com/java-native-access/jna/pull/1178): Add `c.s.j.p.win32.IPHlpAPI#GetTcpStatistics` and `c.s.j.p.win32.IPHlpAPI#GetUdpStatistics` - [@dbwiddis](https://github.com/dbwiddis).
