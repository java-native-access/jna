...
* Fix: `platform.win32.Secur32.AcquireCredentialsHandle`, `InitializeSecurityContext` and `AcceptSecurityContext` in Win32 64-bit - [@dblock](https://github.com/dblock).
