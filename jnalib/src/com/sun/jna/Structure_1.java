 ...
 */
public abstract /*final*/ class Structure_1<S> extends Object
{
	/**
	 *
	 *
	 */
	/*pkg*/ Structure_1(Class<S> structClass)
...
//		else
	...
	{
		// TODO: We should catch this information in WeakMap so that we
...
//			}
		...
		int declaredSize=annotation.size();
...
//			else
	 ...
	 *
	 */
	private class Field extends Object
	{
		public String name;
		public Class type;
