...
v     * @param wide whether to convert from a wide or standard C string
    ...
    */
    ...
    public Pointer putBoolean(boolean value) {
		setByte(0, (byte) (value ? 1 : 0));
		return this;
	}
	
	public Pointer putByte(int value) {
		setByte(0, (byte) value);
		return this;
	}
	
	public Pointer putShort(int value) {
		setShort(0, (short) value);
		return this;
	}
	
	public Pointer putInt(int value) {
		setInt(0, value);
		return this;
	}
	
	public Pointer putLong(long value) {
		setLong(0, value);
		return this;
	}
	
	public Pointer putFloat(float value) {
		setFloat(0, value);
		return this;
	}
	
	public Pointer putDouble(double value) {
		setDouble(0, value);
		return this;
	}
