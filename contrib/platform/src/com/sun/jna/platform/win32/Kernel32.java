...
public interface Kernel32 extends WinNT, Wincon {
	 ...
	 * process.<br>
	 * <br>
	 * BOOL ProcessIdToSessionId(_In_ DWORD dwProcessId, _Out_ DWORD
	 * *pSessionId);<br>
	 * 
	 * @param dwProcessId
	 ...
	 *            module itself, as specified by the <strong>LIBRARY</strong>
	 ...
	 *            the module is loaded as if
	 *            <strong>DONT_RESOLVE_DLL_REFERENCES</strong> was specified.
	 *            See the <em>dwFlags</em> parameter for more information.
	 *            </p>
	 *            <p>
	 ...
	 *            Naming Files, Paths, and Namespaces</a>.
	 *            </p>
	 *            <p>
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td><a id="DONT_RESOLVE_DLL_REFERENCES"></a>
	 *            <a id="dont_resolve_dll_references"></a>
	 *            <dl>
	 *            <dt><strong>DONT_RESOLVE_DLL_REFERENCES</strong></dt>
	 *            <dt>0x00000001</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            system does not call <a href=
	 *            "https://msdn.microsoft.com/en-us/library/windows/desktop/ms682583(v=vs.85).aspx">
	 *            <strong xmlns="http://www.w3.org/1999/xhtml">DllMain</strong>
	 *            </a> for process and thread initialization and termination.
	 *            Also, the system does not load additional executable modules
	 *            that are referenced by the specified module.
	 *            </p>
	 *            <div class="note"><strong>Note</strong>&nbsp;&nbsp;Do not use
	 *            this value; it is provided only for backward compatibility. If
	 *            you are planning to access only data or resources in the DLL,
	 *            use <strong>LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE</strong> or
	 *            <strong>LOAD_LIBRARY_AS_IMAGE_RESOURCE</strong> or both.
	 *            Otherwise, load the library as a DLL or executable module
	 *            using the <a href=
	 *            "https://msdn.microsoft.com/en-us/library/windows/desktop/ms684175(v=vs.85).aspx">
	 *            <strong xmlns="http://www.w3.org/1999/xhtml">LoadLibrary
	 *            </strong></a> function.</div></td>
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_IGNORE_CODE_AUTHZ_LEVEL"></a>
	 *            <a id="load_ignore_code_authz_level"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_IGNORE_CODE_AUTHZ_LEVEL</strong></dt>
	 *            <dt>0x00000010</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            <a href="Http://go.microsoft.com/fwlink/p/?linkid=161970">
	 *            AppLocker</a> rules or apply
	 *            <a href="Http://go.microsoft.com/fwlink/p/?linkid=161971">
	 *            Software Restriction Policies</a> for the DLL. This action
	 *            applies only to the DLL being loaded and not to its
	 *            dependencies. This value is recommended for use in setup
	 *            programs that must run extracted DLLs during installation.
	 *            </p>
	 *            <p>
	 *            <strong>Windows Server&nbsp;2008&nbsp;R2 and
	 *            Windows&nbsp;7:&nbsp;&nbsp;</strong>On systems with KB2532445
	 *            installed, the caller must be running as "LocalSystem" or
	 *            "TrustedInstaller"; otherwise the system ignores this flag.
	 ...
	 *            <a href="Http://support.microsoft.com/kb/2532445">http://
	 *            support.microsoft.com/kb/2532445</a>.
	 *            </p>
	 *            <p>
	 *            <strong>Windows Server&nbsp;2008, Windows&nbsp;Vista, Windows
	 *            Server&nbsp;2003, and Windows&nbsp;XP:&nbsp;&nbsp;</strong>
	 *            AppLocker was introduced in Windows&nbsp;7 and Windows
	 *            Server&nbsp;2008&nbsp;R2.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_AS_DATAFILE"></a>
	 *            <a id="load_library_as_datafile"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_AS_DATAFILE</strong></dt>
	 *            <dt>0x00000002</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            <a href=
	 *            "https://msdn.microsoft.com/en-us/library/windows/desktop/ms683197(v=vs.85).aspx">
	 *            <strong xmlns="http://www.w3.org/1999/xhtml">GetModuleFileName
	 *            </strong></a>, <a href=
	 *            "https://msdn.microsoft.com/en-us/library/windows/desktop/ms683199(v=vs.85).aspx">
	 *            <strong xmlns="http://www.w3.org/1999/xhtml">GetModuleHandle
	 *            </strong></a> or <a href=
	 *            "https://msdn.microsoft.com/en-us/library/windows/desktop/ms683212(v=vs.85).aspx">
	 *            <strong xmlns="http://www.w3.org/1999/xhtml">GetProcAddress
	 *            </strong></a> with this DLL. Using this value causes writes to
	 *            read-only memory to raise an access violation. Use this flag
	 *            when you want to load a DLL only to extract messages or
	 *            resources from it.
	 *            </p>
	 *            <p>
	 *            This value can be used with
	 *            <strong>LOAD_LIBRARY_AS_IMAGE_RESOURCE</strong>. For more
	 *            information, see Remarks.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE"></a>
	 *            <a id="load_library_as_datafile_exclusive"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE</strong></dt>
	 *            <dt>0x00000040</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 *            <p>
	 *            Similar to <strong>LOAD_LIBRARY_AS_DATAFILE</strong>, except
	 *            that the DLL file is opened with exclusive write access for
	 *            the calling process. Other processes cannot open the DLL file
	 *            for write access while it is in use. However, the DLL can
	 *            still be opened by other processes.
	 *            </p>
	 *            <p>
	 *            This value can be used with
	 *            <strong>LOAD_LIBRARY_AS_IMAGE_RESOURCE</strong>. For more
	 ...
	 *            </p>
	 *            <p>
	 *            <strong>Windows Server&nbsp;2003 and
	 *            Windows&nbsp;XP:&nbsp;&nbsp;</strong>This value is not
	 *            supported until Windows&nbsp;Vista.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_AS_IMAGE_RESOURCE"></a>
	 *            <a id="load_library_as_image_resource"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_AS_IMAGE_RESOURCE</strong></dt>
	 *            <dt>0x00000020</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            either <strong>LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE</strong> or
	 *            <strong>LOAD_LIBRARY_AS_DATAFILE</strong>. For more
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_SEARCH_APPLICATION_DIR"></a>
	 *            <a id="load_library_search_application_dir"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_SEARCH_APPLICATION_DIR</strong></dt>
	 *            <dt>0x00000200</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            <strong>LOAD_WITH_ALTERED_SEARCH_PATH</strong>.
	 *            </p>
	 *            <p>
	 *            <strong>Windows&nbsp;7, Windows Server&nbsp;2008&nbsp;R2,
	 *            Windows&nbsp;Vista, and Windows
	 *            Server&nbsp;2008:&nbsp;&nbsp;</strong>This value requires
	 *            <a href="http://go.microsoft.com/fwlink/p/?linkid=217865">
	 *            KB2533623</a> to be installed.
	 *            </p>
	 *            <p>
	 *            <strong>Windows Server&nbsp;2003 and
	 *            Windows&nbsp;XP:&nbsp;&nbsp;</strong>This value is not
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_SEARCH_DEFAULT_DIRS"></a>
	 *            <a id="load_library_search_default_dirs"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_SEARCH_DEFAULT_DIRS</strong></dt>
	 *            <dt>0x00001000</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            <strong>LOAD_LIBRARY_SEARCH_APPLICATION_DIR</strong>,
	 *            <strong>LOAD_LIBRARY_SEARCH_SYSTEM32</strong>, and
	 *            <strong>LOAD_LIBRARY_SEARCH_USER_DIRS</strong>. Directories in
	 *            the standard search path are not searched. This value cannot
	 *            be combined with
	 *            <strong>LOAD_WITH_ALTERED_SEARCH_PATH</strong>.
	 *            </p>
	 *            <p>
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR"></a>
	 *            <a id="load_library_search_dll_load_dir"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR</strong></dt>
	 *            <dt>0x00000100</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            </p>
	 *            <p>
	 *            The <em>lpFileName</em> parameter must specify a fully
	 *            qualified path. This value cannot be combined with
	 *            <strong>LOAD_WITH_ALTERED_SEARCH_PATH</strong>.
	 *            </p>
	 *            <p>
	 ...
	 *            <strong>LOAD_LIBRARY_DEFAULT_DIRS</strong>.
	 *            </p>
	 *            <p>
	 *            <strong>Windows&nbsp;7, Windows Server&nbsp;2008&nbsp;R2,
	 *            Windows&nbsp;Vista, and Windows
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_SEARCH_SYSTEM32"></a>
	 *            <a id="load_library_search_system32"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_SEARCH_SYSTEM32</strong></dt>
	 *            <dt>0x00000800</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_LIBRARY_SEARCH_USER_DIRS"></a>
	 *            <a id="load_library_search_user_dirs"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_LIBRARY_SEARCH_USER_DIRS</strong></dt>
	 *            <dt>0x00000400</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 *            <p>
	 *            If this value is used, directories added using the <a href=
	 *            "https://msdn.microsoft.com/en-us/library/windows/desktop/hh310513(v=vs.85).aspx">
	 *            <strong xmlns="http://www.w3.org/1999/xhtml">AddDllDirectory
	 *            </strong></a> or the <a href=
	 *            "https://msdn.microsoft.com/en-us/library/windows/desktop/ms686203(v=vs.85).aspx">
	 *            <strong xmlns="http://www.w3.org/1999/xhtml">SetDllDirectory
	 *            </strong></a> function are searched for the DLL and its
	 *            dependencies. If more than one directory has been added, the
	 ...
	 *            </tr>
	 *            <tr>
	 *            <td><a id="LOAD_WITH_ALTERED_SEARCH_PATH"></a>
	 *            <a id="load_with_altered_search_path"></a>
	 *            <dl>
	 *            <dt><strong>LOAD_WITH_ALTERED_SEARCH_PATH</strong></dt>
	 *            <dt>0x00000008</dt>
	 *            </dl>
	 *            </td>
	 *            <td>
	 ...
	 *            <strong>LOAD_LIBRARY_SEARCH</strong> flag.
	 *            </p>
	 *            </td>
	 *            </tr>
	 *            </tbody>
