...
public interface Advapi32 extends StdCallLibrary {
	...
	/**
	 * CREATE_NO_WINDOW: 0x08000000<br>
	 * The process is a console application that is being run without a console
	 * window.<br>
	 * Therefore, the console handle for the application is not set.<br>
	 * This flag is ignored if the application is not a console application, or
	 * if it is used with either CREATE_NEW_CONSOLE or DETACHED_PROCESS.<br>
	 */
	 ...
	 * lpStartupInfo parameter specifies a STARTUPINFOEX structure.<br>
	 ...
	 * console. This flag cannot be used with the DETACHED_PROCESS flag.<br>
	 * This flag is enabled by default.<br>
	 */
	int CREATE_NEW_CONSOLE = 0x00000010;

	/**
	 * DETACHED_PROCESS: 0x00000008<br>
	 * For console processes, the new process does not inherit its parent's
	 * console (the default).<br>
	 * The new process can call the AllocConsole function at a later time to
	 * create a console.<br>
	 * For more information, see Creation of a Console. This value cannot be
