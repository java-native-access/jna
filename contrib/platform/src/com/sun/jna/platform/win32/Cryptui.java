...
public interface Cryptui extends StdCallLibrary {
     ...
     */
    int CRYPTUI_WIZ_IGNORE_NO_UI_FLAG_FOR_CSPS = 0x0002;
    /**
     ...
     */
    int CRYPTUI_WIZ_NO_UI_EXCEPT_CSP = 0x0003;
    /**
     * Allow certificates to be imported.
     */
    int CRYPTUI_WIZ_IMPORT_ALLOW_CERT = 0x00020000;
    /**
     * Allow CRLs to be imported.
     */
    int CRYPTUI_WIZ_IMPORT_ALLOW_CRL = 0x00040000;
    /**
     * Allow CTLs to be imported.
     */
    int CRYPTUI_WIZ_IMPORT_ALLOW_CTL = 0x00080000;
    /**
     * Do not allow the user to change the destination certificate store
     * represented by the hDestCertStore parameter.
     */
    int CRYPTUI_WIZ_IMPORT_NO_CHANGE_DEST_STORE = 0x00010000;
    /**
     ...
     */
    int CRYPTUI_WIZ_IMPORT_TO_LOCALMACHINE = 0x00100000;
    /**
     * Import the object to the certificate store for the current user. This
     * applies only to PFX imports.
     */
    int CRYPTUI_WIZ_IMPORT_TO_CURRENTUSER = 0x00200000;
    /**
     ...
     */
    boolean CryptUIWizImport(int dwFlags, HWND hwndParent, String pwszWizardTitle,
     ...
     * @param dwFlags Contains flags that modify the behavior of the function.
     * This can be zero or a combination of one or more of the following values.
     * @param hwndParent The handle of the window to use as the parent of the
     * dialog box that this function creates. This parameter is ignored if the
     * CRYPT_WIZ_NO_UI flag is set in dwFlags.
     * @param pwszWizardTitle A pointer to a null-terminated Unicode string that
     * contains the title to use in the dialog box that this function creates.
     * This parameter is ignored if the CRYPT_WIZ_NO_UI flag is set in dwFlags.
     * @param pExportInfo A pointer to a CRYPTUI_WIZ_EXPORT_INFO structure that
     * contains information about producing the export wizard.
     ...
     * GetLastError function.
     */
    boolean CryptUIWizExport(int dwFlags, HWND hwndParent, String pwszWizardTitle,
            CRYPTUI_WIZ_EXPORT_INFO pExportInfo, Pointer pvoid);
